...
#pragma region Generic Definitions
		...
		static __compelled_inline_noseh bool __regcall compare_memory(T word1, T2 word2) noexcept {
			bool same = true;
		...
		static __compelled_inline_noseh bool __regcall fast_compare_string(const std::string string1, const std::string string2) noexcept {
		...
		static __compelled_inline_noseh bool __regcall fast_compare_wstring(std::wstring string1, std::wstring string2) noexcept {
		...
		inline void __regcall SCRAMBLE_CRITICAL_CONDITION(
