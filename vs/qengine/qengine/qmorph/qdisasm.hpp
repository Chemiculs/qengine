...
#pragma region Permutation Functions
			...
			inline INT32 __regcall get_permutation_index(BYTE original_instruction) {
			...
			inline instruction_permutations __regcall get_permutation_instruction(INT32 index) {
		...
		public:
			...
			inline void __regcall instruction_permutation(interrupt_region& region) {
				DWORD protection{};
			...
			bool __stackcall analyze_executable_sections() {
			...
			inline bool __regcall morph_executable_sections(bool free_memory = true) {
...
#pragma region PE Header Manipulation
			...
			inline bool __stackcall zero_dos_header(bool erase_stub = true) {
			...
			inline bool __stackcall scramble_dos_header(bool erase_stub = true) {
...
#pragma endregion
			...
			inline bool __stackcall zero_nt_header() {
			...
			inline bool __stackcall scramble_nt_header() {
...
#pragma endregion
			...
			inline bool __stackcall zero_information_sections() {
...
#pragma endregion
			...
			inline void __stackcall parse_main_module_headers() {
...
#pragma region Ctor / Dtor
			...
			inline __stackcall qsection_assembler() {
