...
#pragma region Get Accessors
			...
			inline const uintptr_t __cdecl function_address() const noexcept {
...
#pragma region Set Accessors
			...
			inline void __fastcall has_exception_triggered(bool state) noexcept {
...
#pragma region Ctor / Dtor
			...
			inline __fastcall qhook_fn(const void* fn_address) 
