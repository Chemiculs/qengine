...
namespace qengine {
	...
	namespace qhook {
		...
		public:
			...
			static inline qhook_detection_t* __fastcall analyze_fn_hook_presence(
			...
			static inline std::size_t __fastcall analyze_fn_length(const void* fn_address, csh& cs_handle_) noexcept {
