...
#pragma region Global Instantiation
			...
			inline void __cdecl initialize_globals() noexcept {
...
#pragma region Scan Loop
			...
			static __statcall void __cdecl do_hook_scans() noexcept {
...
#pragma region Helper Functions
			...
			inline void __fastcall apply_callback_fn( void(__fastcall* fn)(qhook_detection_t*) ) noexcept {
			...
			inline void __fastcall remove_fn(const void* fn_address) noexcept {
...
#pragma region Instanced Ctor / Static Dtor
			...
			inline qhook_thread_pool(void* fn = nullptr) noexcept {
			...
			static inline void __cdecl free_pool() noexcept {
...
#pragma region Low Level Exception Callback Routine
			...
			static __statcall void __fastcall base_exception_handler(qhook_detection_t* except) noexcept {
...
#pragma region Helper Functions
			...
			inline void __cdecl remove_from_scan_pool() noexcept {
			...
			static inline void __fastcall set_client_callback_fn(qcallback::qmem_except_hook callback) noexcept {
			...
			static inline void __cdecl terminate_scan_thread() noexcept {
