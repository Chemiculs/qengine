...
#pragma endregion
		...
		private:
			...
			static inline T WINAPI invoke_internal(uintptr_t fn, args... arguments) {
		...
		public:
			...
			template<typename T, typename... args>
			static inline T WINAPI invoke(string_t library_name, std::string fn_str, args... arguments) {
			...
			template<typename T, typename... args>
			static inline T WINAPI invoke(string_t library_name, WORD ordinal_number, args... arguments) {
				auto handle = LoadLibrary(library_name.c_str());
