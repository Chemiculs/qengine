...
namespace qengine {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __regcall qh_int8(const char value = 0) noexcept {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __regcall qh_uint8(const std::uint8_t value = 0) noexcept {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __regcall qh_int16(const short value = 0) noexcept {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __regcall qh_uint16(std::uint16_t value = 0) noexcept {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __regcall qh_int32(int value = 0) noexcept {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __regcall qh_uint32(std::uint32_t value = 0) noexcept {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __regcall qh_int64(int64_t value = 0) noexcept {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __regcall qh_uint64(std::uint64_t value = 0) noexcept {
	...
	#pragma region Operators
			...
			__compelled_inline_noseh ~qh_m256d() noexcept { }
	#pragma endregion
		};
