...
namespace qengine {
	...
	#pragma region Global Static Methods / Callbacks
		...
		static __compelled_inline_noseh void __regcall init_hash_t(qcallback::qmem_exception_rogue_c callback = violation_callback_d) noexcept {
	...
	#pragma region Operators
			...
			__compelled_inline_noseh __stackcall ~qh_int8() noexcept { }
	...
	#pragma region Operators
			...
			__compelled_inline_noseh __stackcall ~qh_uint8() { }
	#pragma endregion
		};
	...
	#pragma region Accessors
			...
			__compelled_inline_noseh void __regcall set(std::int16_t value) noexcept {
	...
	#pragma region Operators
			...
			__compelled_inline_noseh qh_int16 __regcall operator+(const std::int16_t value) const noexcept {
			...
			__compelled_inline_noseh qh_int16& __regcall operator+=(const std::int16_t value) noexcept {
			...
			__compelled_inline_noseh __stackcall ~qh_int16() { }
	...
	#pragma region Operators
			...
			__compelled_inline_noseh __stackcall ~qh_uint16() {	}
	#pragma endregion
		};
	...
	#pragma region Accessors
			...
			__compelled_inline_noseh std::int32_t __stackcall get() const noexcept {
			...
			__compelled_inline_noseh void __regcall set(std::int32_t value) noexcept {
	...
	#pragma region Operators
			...
			__compelled_inline_noseh qh_int32 __regcall operator+(const std::int32_t value) const noexcept {
			...
			__compelled_inline_noseh qh_int32 __regcall operator*(const istd::int32_tnt value) const noexcept {
				return qh_int32(get() * value);
			}
			...
			__compelled_inline_noseh qh_int32& __regcall operator+=(const std::int32_t value) noexcept {
			...
			__compelled_inline_noseh __regcall operator std::int32_t() const noexcept {
				return get();
			}

			__compelled_inline_noseh __stackcall ~qh_int32() noexcept { }
	#pragma endregion
		};
	...
	#pragma region Operators
			...
			__compelled_inline_noseh __stackcall ~qh_uint32() noexcept { }
	#pragma endregion
		};
	...
	#pragma region Accessors
			...
			__compelled_inline_noseh void __regcall set(std::int64_t value) noexcept {
	...
	#pragma region Operators
			...
			__compelled_inline_noseh __regcall operator std::int64_t() const noexcept {
				return get();
			}

			__compelled_inline_noseh __stackcall ~qh_int64() noexcept { }
	#pragma endregion
		};
	...
	#pragma region Operators
			...
			__compelled_inline_noseh __stackcall ~qh_uint64() noexcept { }
	#pragma endregion
		};
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qh_float(const float value = 0.0f) noexcept {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qh_double(const double value = static_cast<double>(0.0f)) noexcept {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qh_m128(const __m128 value) noexcept {
	...
	#pragma region Operators
			...
			__compelled_inline_noseh __stackcall ~qh_m128() noexcept { }
	#pragma endregion
		};
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qh_m128i(const __m128i value) {
	...
	#pragma region Operators
			...
			__compelled_inline_noseh __stackcall ~qh_m128i() { }
	#pragma endregion
		};
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qh_m128d(const __m128d value) noexcept {
	...
	#pragma region Operators
			...
			__compelled_inline_noseh __stackcall ~qh_m128d() noexcept { }
	#pragma endregion
		};
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qh_m256(const __m256 value) noexcept {
	...
	#pragma region Operators
			...
			__compelled_inline_noseh __stackcall ~qh_m256() noexcept { }
	#pragma endregion
		};
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qh_m256i(const __m256i value) noexcept {
	...
	#pragma region Operators
			...
			__compelled_inline_noseh __stackcall ~qh_m256i() noexcept { }
	#pragma endregion
		};
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qh_m256d(const __m256d value) noexcept {
	...
	#pragma region Ctor
			...
			__compelled_inline_noseh __regcall qh_malloc(const std::size_t size = 0) : allocation_size(size) {
	...
	#pragma region Get / Set
			...
			__compelled_inline_noseh bool __regcall get(void* destination, std::uintptr_t offset, std::size_t length) const noexcept {
			...
			__compelled_inline_noseh char __regcall get(std::uintptr_t offset) const noexcept {
			...
			__compelled_inline_noseh bool __regcall set(void* source, std::uintptr_t offset, std::size_t length) noexcept {
			...
			__compelled_inline_noseh bool __regcall set(std::uintptr_t index, std::int8_t value) noexcept {
	...
	#pragma region Property Accessors
			...
			__compelled_inline_noseh std::size_t __stackcall length() const noexcept {
	...
	#pragma region Utility functions
			...
			__compelled_inline_noseh const bool __regcall reallocate(std::size_t size) noexcept {
			...
			__compelled_inline_noseh const bool __regcall swap(void* allocation_, std::size_t size) noexcept {
