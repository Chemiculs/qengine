...
#pragma region Pseudo-Ctor
		...
		static __forceinline void __cdecl polyc_init() noexcept {
...
#pragma region Algorithm
		...
		static __forceinline void __fastcall algo(void* data, const size_t length) noexcept {
			if (!initialized)
				polyc_init();
		...
		static __forceinline void* __fastcall algo_inst(void* data, size_t length) noexcept {
		...
		template<typename T>
		static __forceinline void __fastcall algo_t(T& data) noexcept {

			algo(&data, sizeof(decltype(data)));
		}

		template<typename T>
		static __forceinline T __fastcall algo_t_inst(T data) noexcept {
		...
		static __forceinline void __cdecl algo_str(const std::string& data) noexcept {

			algo(const_cast<char*>(data.c_str()), data.length());
		}

		static __forceinline std::string __cdecl algo_str_inst(const std::string& data) noexcept {
		...
		static __forceinline void __cdecl algo_wstr(const std::wstring& data) noexcept {

			algo(const_cast<wchar_t*>(data.c_str()), data.size() * sizeof(wchar_t));
		}

		static __forceinline std::wstring __cdecl algo_wstr_inst(const std::wstring& data) noexcept {
