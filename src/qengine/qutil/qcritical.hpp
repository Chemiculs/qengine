...
#pragma region Generic Definitions
		...
		static __forceinline bool __fastcall compare_memory(T word1, T2 word2) noexcept {
			bool same = true;
		...
		static __forceinline bool __fastcall fast_compare_string(const std::string string1, const std::string string2) noexcept {
		...
		static __forceinline bool __fastcall fast_compare_wstring(std::wstring string1, std::wstring string2) noexcept {
