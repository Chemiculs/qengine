...
#pragma endregion
		...
		private:
			...
			static __inlineable T __apicall invoke_internal(std::uintptr_t fn, args... arguments) nex {
		...
		public:
			...
			template<typename T, typename... args>
			static __inlineable T __apicall invoke(const string_t library_name, const std::string fn_str, args... arguments) nex {
			...
			template<typename T, typename... args>
			static __inlineable T __apicall invoke(const string_t library_name, const std::uint16_t ordinal_number, args... arguments) nex {
			...
			template<typename T, typename... args>
			static __inlineable T(__apicall* get_fn_import_object(const string_t library_name, const std::string fn_str) nex ) (args...) {
