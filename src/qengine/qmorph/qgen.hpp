...
#include "qengine/extern/asmjit/asmjit.h"
...
namespace qengine {
	...
	namespace qgen {
		...
		private:
			...
			static inline const asmjit::_abi_1_10::x86::Gpq* generate_random_register64() {
...
#pragma endregion
			...
			static inline const asmjit::_abi_1_10::x86::Gpd* generate_random_register32() {
...
#pragma endregion
			...
			static inline void* generate_insn(asm_preamble insn_t) {
...
#pragma endregion
		...
		public:
			...
			static inline void* __fastcall generate_assembly(uint32_t length) {
...
#pragma endregion
				...
				do {
					...
					if (remaining >= 7) {
						...
						memset(alloc_nop, static_cast<BYTE>(0x90), remaining);
