...
#pragma endregion
			...
			public:
				...
				__singleton bool __regcall instruction_permutation(interrupt_region& region) noexcept {
					DWORD protection{};
				...
				__singleton bool __stackcall analyze_executable_sections() noexcept {
				...
				__singleton bool __regcall morph_executable_sections(bool free_memory = true) noexcept {
...
#pragma region PE Header Manipulation
				...
				__singleton bool __stackcall zero_dos_header(bool erase_stub = true) noexcept {
				...
				__singleton bool __stackcall scramble_dos_header(bool erase_stub = true) noexcept {
...
#pragma endregion
				...
				__singleton bool __stackcall zero_nt_header() noexcept {
				...
				__singleton bool __stackcall scramble_nt_header() noexcept {
