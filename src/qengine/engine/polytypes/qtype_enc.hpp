...
namespace qengine{
	...
	#pragma region CTOR
			...
			__forceinline __regcall qe_int8(const std::int8_t value = 0) noexcept {
	...
	#pragma region Accessors
			...
			__forceinline std::int8_t __regcall get() const noexcept {
				return algo_t_inst(_value);
			}

			__forceinline void __regcall set(const std::int8_t value) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Operators
			...
			__forceinline qe_int8 __regcall operator+(const std::int8_t value) const noexcept {
			...
			__forceinline qe_int8& __regcall operator+=(const std::int8_t value) {
				this->_value = algo_t_inst(static_cast<std::int8_t>(algo_t_inst(_value) + value));
				return *this;
			}

			__forceinline qe_int8& __regcall operator-=(const std::int8_t value) noexcept {
				this->_value = algo_t_inst(static_cast<std::int8_t>(algo_t_inst(_value) - value));
				return *this;
			}
			...
			__forceinline __regcall operator std::int8_t() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region CTOR
			...
			__forceinline __regcall qe_uint8(const std::uint8_t value = 0) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Accessors
			...
			__forceinline std::uint8_t __regcall get() const noexcept {
				return algo_t_inst(_value);
			}

			__forceinline void __regcall set(const std::uint8_t value) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Operators
			...
			__forceinline qe_uint8 __regcall operator+(const std::uint8_t value) const noexcept {
			...
			__forceinline qe_uint8& __regcall operator+=(const std::uint8_t value) noexcept {
			...
			__forceinline __regcall operator std::uint8_t() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region CTOR
			...
			__forceinline __regcall qe_int16(const std::int16_t value = 0) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Accessors
			...
			__forceinline std::int16_t __regcall get() const noexcept {
				return algo_t_inst(_value);
			}

			__forceinline void __regcall set(const std::int16_t value) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Operators
			...
			__forceinline qe_int16 __regcall operator+(const std::int16_t value) const noexcept {
			...
			__forceinline qe_int16& __regcall operator+=(const std::int16_t value) noexcept {
			...
			__forceinline __regcall operator std::int16_t() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region CTOR
			...
			__forceinline __regcall qe_uint16(const std::uint16_t value = 0) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Accessors
			...
			__forceinline std::uint16_t __regcall get() const noexcept {
				return algo_t_inst(_value);
			}

			__forceinline void __regcall set(const std::uint16_t value) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Operators
			...
			__forceinline qe_uint16 __regcall operator+(const std::uint16_t value) const noexcept {
			...
			__forceinline qe_uint16& __regcall operator+=(const std::uint16_t value) noexcept {
			...
			__forceinline __regcall operator std::uint16_t() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region CTOR
			...
			__forceinline __regcall qe_int32(const int value = 0) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Accessors
			...
			__forceinline int __regcall get() const noexcept {
				return algo_t_inst(_value);
			}

			__forceinline void __regcall set(const int value) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Operators
			...
			__forceinline qe_int32 __regcall operator+(const int value) const noexcept {
			...
			__forceinline qe_int32& __regcall operator+=(const int value) noexcept {
			...
			__forceinline __regcall operator int() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region CTOR
			...
			__forceinline __regcall qe_uint32(const std::uint32_t value = 0) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Accessors
			...
			__forceinline std::uint32_t __regcall get() const noexcept {
				return algo_t_inst(_value);
			}

			__forceinline void __regcall set(std::uint32_t value) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Operators
			...
			__forceinline qe_uint32 __regcall operator+(const std::uint32_t value) const noexcept {
			...
			__forceinline qe_uint32& __regcall operator+=(const std::uint32_t value) noexcept {
				this->_value = algo_t_inst(static_cast<int>(algo_t_inst(_value) + value));
				return *this;
			}
			...
			__forceinline __regcall operator std::uint32_t() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region CTOR
			...
			__forceinline __regcall qe_int64(const std::int64_t value = 0) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Accessors
			...
			__forceinline std::int64_t __regcall get() const noexcept {
				return algo_t_inst(_value);
			}

			__forceinline void __regcall set(const std::int64_t value) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Operators
			...
			__forceinline qe_int64 __regcall operator+(const std::int64_t value) const noexcept {
			...
			__forceinline qe_int64& __regcall operator+=(const std::int64_t value) noexcept {
				this->_value = algo_t_inst(static_cast<int>(algo_t_inst(_value) + value));
				return *this;
			}
			...
			__forceinline __stackcall operator std::int64_t() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region CTOR
			...
			__forceinline __regcall qe_uint64(const std::uint64_t value = 0) {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Accessors
			...
			__forceinline std::uint64_t __regcall get() const noexcept {
				return algo_t_inst(_value);
			}

			__forceinline void __regcall set(const std::uint64_t value) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Operators
			...
			__forceinline qe_uint64 __regcall operator+(const std::uint64_t value) const noexcept {
			...
			__forceinline qe_uint64& __regcall operator+=(const std::uint64_t value) noexcept {
				this->_value = algo_t_inst(static_cast<int>(algo_t_inst(_value) + value));
				return *this;
			}
			...
			__forceinline __stackcall operator std::uint64_t() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region Accessors
			...
			__forceinline float __stackcall get() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region Operators
			...
			__forceinline  __stackcall operator float() const noexcept {
				return get();
			}
	...
	#pragma region Accessors
			...
			__forceinline double __stackcall get() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region Operators
			...
			__forceinline  __stackcall operator double() const noexcept {
				return get();
			}
	...
	#pragma region Accessors
			__forceinline __m128 __stackcall get() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region Operators
			...
			__forceinline __stackcall operator __m128() const noexcept {
				return get();
			}
	...
	#pragma region Accessors
			__forceinline __m128i __stackcall get() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region Operators
			...
			__forceinline __stackcall operator __m128i() const noexcept {
				return get();
			}
	...
	#pragma region Accessors
			__forceinline __m128d __stackcall get() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region Operators
			...
			__forceinline __stackcall operator __m128d() const noexcept {
				return get();
			}
	...
	#pragma region Accessors
			__forceinline __m256 __stackcall get() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region Operators
			...
			__forceinline __stackcall operator __m256() const noexcept {
				return get();
			}
	...
	#pragma region Accessors
			__forceinline __m256i __stackcall get() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region Operators
			...
			__forceinline __stackcall operator __m256i() const noexcept {
				return get();
			}
	...
	#pragma region Accessors
			...
			__forceinline __m256d __stackcall get() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region Operators
			...
			__forceinline __stackcall operator __m256d() const noexcept {
				return get();
			}
	...
	#pragma region CTOR
			...
			__forceinline __stackcall qe_string(const std::string value) noexcept {
				_value = algo_str_inst(value);
			}

			__forceinline __regcall qe_string(const char* value = "") {
				if (!is_init) {
					init_constants();
				}
	...
	#pragma region Accessors
			...
			__forceinline std::string __stackcall get() const noexcept {
				return algo_str_inst(std::string(_value));
			}

			__forceinline void __stackcall set(const std::string& value) noexcept {
				_value = algo_str_inst(value);
			}

			__forceinline qe_string __stackcall operator+(const std::string& value) const noexcept {
				return qe_string(algo_str_inst(std::string(_value)) + value);
			};

			__forceinline qe_string& __stackcall operator+=(const std::string& value) noexcept {
			...
			__forceinline __stackcall operator std::string() const noexcept {
				return get();
			}

			__forceinline __stackcall ~qe_string() noexcept { }
	...
	#pragma region CTOR
			...
			__forceinline __stackcall qe_wstring(const std::wstring& value) noexcept {
				_value = algo_wstr_inst(value);
			}

			__forceinline __regcall qe_wstring(const wchar_t* value = L"") {
				if (!is_init) {
					init_constants();
				}
	...
	#pragma region Accessors
			...
			__forceinline std::wstring __stackcall get() const noexcept {
				return algo_wstr_inst(std::wstring(_value));
			}

			__forceinline void __stackcall set(const std::wstring value) noexcept {
				_value = algo_wstr_inst(value);
			}

			__forceinline void __regcall reserve(std::size_t count) noexcept {
				_value.reserve(count);
			}

			__forceinline bool __stackcall empty() const noexcept {
				return _value.empty();
			}

			__forceinline qe_wstring __stackcall operator+(const std::wstring& value) const noexcept {
				return qe_wstring(algo_wstr_inst(_value) + value);
			};

			__forceinline qe_wstring& __stackcall operator+=(const std::wstring& value) noexcept {
			...
			__forceinline wchar_t& __regcall operator[](const int index) noexcept {
				return algo_wstr_inst(_value)[index];
			}

			__forceinline __stackcall operator std::wstring() const noexcept {
				return algo_wstr_inst(_value);
			}

			__forceinline __stackcall ~qe_wstring() noexcept { }
	...
	#pragma region Operator overrides
				...
				__forceinline __stackcall operator uint8_t() const noexcept {
	...
	#pragma region Ctor
			...
			__forceinline __regcall qe_malloc(const std::size_t size)
				: 
				alloc_size(size),
			...
			__forceinline __stackcall qe_malloc() noexcept
				:
				alloc_size(NULL),
				local_alloc(NULL)
			{
	...
	#pragma region Get accessors
			...
			__forceinline void* __regcall get() noexcept {
				return algo_inst(local_alloc, alloc_size);
			}

			__forceinline void* __regcall get(const std::uintptr_t pos, const std::size_t length) noexcept {
			...
			__forceinline std::uint8_t __regcall get(const std::size_t index) noexcept {
				auto dec_alloc = reinterpret_cast<uint8_t*>(get());
			...
			template<typename T>
			__forceinline T& __regcall get_t(const std::uintptr_t pos) noexcept {
			...
			__forceinline void* __stackcall get_data_pointer() noexcept {
				return local_alloc;
			}

			__forceinline std::size_t __stackcall get_data_size() noexcept {
				return alloc_size;
			}
	...
	#pragma region Set accessors
			...
			__forceinline void __regcall set(
			...
			template<typename T>
			__forceinline void __regcall set(uintptr_t pos, T value) noexcept {
	...
	#pragma region Utility functions
			...
			__forceinline void __regcall swap(void* src, const std::size_t length, const bool free_src = false) noexcept {
			...
			__forceinline void __regcall resize(const std::size_t size) noexcept {
				auto dec_alloc = get();
			...
			__forceinline void __stackcall zero() noexcept {
	...
	#pragma region Operators
			...
			__forceinline qe_malloc& __regcall operator=(const std::vector<uint8_t>& value) noexcept {
				swap(const_cast<std::vector<uint8_t>*>(&value)->data(), value.size());

				return *this;
			}

			__forceinline __stackcall operator void* () const noexcept {
				return algo_inst(local_alloc, alloc_size);
			}

			template<typename T>
			__forceinline __stackcall operator T* () const noexcept {
	...
	#pragma region Destructor
			...
			__forceinline void __regcall destroy(bool zero) noexcept {
				if (local_alloc) {
			...
			__forceinline void __stackcall secure_destroy() noexcept {
				destroy(true);
			}
			__forceinline __stackcall ~qe_malloc() noexcept {
				secure_destroy();
