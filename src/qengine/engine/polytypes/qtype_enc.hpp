...
namespace qengine{
	...
	#pragma region Accessors
			...
			__compelled_inline_noseh std::int8_t __regcall get() const noexcept {
	...
	#pragma region Accessors
			...
			__compelled_inline_noseh std::uint8_t __regcall get() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region Accessors
			...
			__compelled_inline_noseh std::int16_t __regcall get() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region Accessors
			...
			__compelled_inline_noseh std::int64_t __regcall get() const noexcept {
				return algo_t_inst(_value);
			}
	...
	#pragma region CTOR
			...
			__optimized_ctor qe_string(const char* value = "") {
				if (!is_init) {
					init_constants();
				}
	...
	#pragma region CTOR
			...
			__optimized_ctor qe_wstring(const wchar_t* value = L"") {
				if (!is_init) {
					init_constants();
				}
	...
	#pragma region Get accessors
			...
			__compelled_inline_noseh void* __regcall get() noexcept {
