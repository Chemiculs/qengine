...
namespace qengine {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __regcall qeh_int16(const short value = 0) noexcept : _value(algo_t_inst(value)) {
	...
	#pragma region Accessors
			...
			__compelled_inline_noseh void __regcall set(const short value) noexcept {
				_value = algo_t_inst(value);
			}
	...
	#pragma region Operators
			...
			__compelled_inline_noseh qeh_int16 __regcall operator+(const short value) const noexcept {
			...
			__compelled_inline_noseh __stackcall operator short() const noexcept {
				return algo_t_inst(_value.get());
			}
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __regcall qeh_int32(const int value = 0) noexcept : _value(algo_t_inst(value)) {
	...
	#pragma region Operators
			...
			__compelled_inline_noseh qeh_int32 __regcall operator+(const int value) const noexcept {
			...
			__compelled_inline_noseh qeh_int32& __regcall operator+=(const int value) noexcept {
			...
			__compelled_inline_noseh __stackcall operator int() const noexcept {
				return get();
			}
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qeh_m128(__m128 value) noexcept : _value(algo_t_inst(value)) {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qeh_m128i(__m128i value) noexcept : _value(algo_t_inst(value)) {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qeh_m128d(__m128d value) noexcept : _value(algo_t_inst(value)) {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qeh_m256(__m256 value) noexcept : _value(algo_t_inst(value)) {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qeh_m256i(__m256i value) noexcept : _value(algo_t_inst(value)) {
	...
	#pragma region CTOR
			...
			__compelled_inline_noseh __fpcall qeh_m256d(__m256d value) noexcept : _value(algo_t_inst(value)) {
	...
	#pragma region Operator overrides
				...
				__compelled_inline_noseh byte& operator=(byte value) noexcept {
				...
				__compelled_inline_noseh __regcall operator byte() const noexcept {
	...
	#pragma region Ctor
			...
			__compelled_inline_noseh __regcall qeh_malloc(size_t size) noexcept : allocation(size) {
				if (!size)
					return;
	...
	#pragma region Get Accessors
			...
			__compelled_inline_noseh void __regcall get(uintptr_t source_position, void* destination, size_t length) const noexcept {
			...
			__compelled_inline_noseh byte __regcall get(uintptr_t position) const noexcept {
				byte _return = NULL;
	...
	#pragma region Set Accessors
			...
			__compelled_inline_noseh void __regcall set(uintptr_t position, void* data, size_t length) noexcept {
			...
			template<typename T>
			__compelled_inline_noseh void __regcall set(uintptr_t position, T value) noexcept {
	...
	#pragma region Utility functions
			...
			__compelled_inline_noseh void __regcall reallocate(size_t size) noexcept {
				allocation.reallocate(size);
			}

			__compelled_inline_noseh const bool __regcall swap(void* allocation_, size_t size, bool free_source = false) noexcept {
				if (!size)
					return false;
